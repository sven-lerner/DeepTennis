...
'''
depricated data loading utilities, deprecated once we settled on fields to use and extracted
data into more easily lodable csvs
for the most part these guys deal with extracting information from the csvs as well as dealing with some 
'qirks' in the data
'''
